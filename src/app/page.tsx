...
const LandingPage = async () => {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 right-0 bottom-0 left-0 z-[-1] bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_80%)] bg-[size:14px_24px]"></div>
      <div className="relative z-[10] flex min-h-screen flex-col items-center pt-56">
        ...
        <p className="mb-8 max-w-xl text-center text-xl text-gray-600">
          OMNIBOX is a minimalistic, AI-powered email client that empowers
        ...
        <div className="space-x-4">
          ...
          <Link href={process.env.NEXT_PUBLIC_URL + "/terms-of-service"}>
